...
class TD3(object): # checked
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.writer = SummaryWriter(log_dir="~/DRL2/DRL_robot_navigation_ros2/src/td3/scripts/runs")
            ...
            if timestep < max_timesteps:
                ...
                if done:
                    ...
                    if timesteps_since_eval >= eval_freq:
                        ...
                        network.save(file_name, directory="~/DRL2/DRL_robot_navigation_ros2/src/td3/scripts/pytorch_models")
